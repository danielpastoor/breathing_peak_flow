...
de breathing peak flow in de verschillende groepen. Figuur \@ref(fig:female-box-plot) toont de boxplots 
...
Figure \@ref(fig:male-box-plot) toont de boxplots van de piekstroom bij mannen die oefeningen doen 
...
bij mensen die wel en niet sporten. Figure \@ref(fig:sporting-histograms) toont het histogram van de piekstroom 
...
Fugure \@ref(fig:no-sporting-histograms) toont het histogram van de piekstroom bij mensen die niet sporten, ook 
...
[Table \@ref(tab:normal-distribution-of-data)] hieruit kan worden gehaald dat alle mogelijke combinaties een p-value boven de 0.05 hebben, en dus normaal verdeeld zijn.
...
Hiernaast wordt er gekeken of er verschillen zitten in de peakflow bij de verschillende groepen voor en na 10 jumping jacks Table [\@ref(tab:different-t-test-on-groups)]
...
Doormiddel van een ANOVA test wordt de effect van de factoren: sexsen, of de persoon sport en de uitvoering van een kleine sportieve activiteit.Table [\@ref(tab:ANOVA)]
