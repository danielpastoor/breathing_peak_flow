...
mean_ajj_woman <- mean(normaal_verd_ajj_woman$Peak_flow)
  
mean_bjj_woman <- mean(normaal_verd_bjj_woman$Peak_flow)

t.test(normaal_verd_ajj_woman$Peak_flow, y= normaal_verd_bjj_woman$Peak_flow, alternative ="two.sided", paired = TRUE)

sporting_Woman <- data_woman %>% filter(Sporting == T)
not_sporting_woman <- data_woman %>% filter(Sporting == F)

t.test(sporting_Woman$Peak_flow, y=not_sporting_woman$Peak_flow, alternative = "greater")
```
